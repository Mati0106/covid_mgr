...
# model = load_model('poland_deaths_final.h5')
...
initial_results.to_csv(path.joinpath('PL_deaths_initial.csv'), index=False)
...
final_results.to_csv(path.joinpath('PL_deaths_final.csv'), index=False)

# uncomment to save a model
# model.save('poland_deaths_final.h5')
