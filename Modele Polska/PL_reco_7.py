...
# model = load_model('poland_reco_final.h5')
...
initial_results.to_csv(path.joinpath('PL_reco_initial.csv'))
...
final_results.to_csv(path.joinpath('PL_reco_final.csv'))

# uncomment to save a model
# model.save('poland_reco_final.h5')
