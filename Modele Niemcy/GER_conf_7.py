...
# model = load_model('germany_conf_final.h5')
...
initial_results.to_csv(path.joinpath('GER_conf_initial.csv'), index=False)
...
final_results.to_csv(path.joinpath('GER_conf_final.csv'), index=False)
# uncomment to save a model
# model.save('germany_conf_final.h5')
